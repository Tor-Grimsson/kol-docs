    ...
    <div className="space-y-8">
      ...
      <DocsArticle className="wiki-article-section space-y-6">
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <div className="rounded border border-fg-08 p-4 space-y-3">
            <p className="wiki-section-label">Tasks</p>
            {database.tasks.map((task) => (
              <div key={task.id} className="rounded border border-fg-08 p-3">
        ...
        <div className="grid gap-4">
          {database.pages.map((page) => (
            <Link
              ...
              className="rounded border border-fg-08 p-4 hover:border-fg-16 space-y-2"
            >
