...
const BlockEditorCard = memo(({ block, onChange, onRemove }) => {
  ...
  const sharedTextareaProps = {
    className:
      'w-full rounded-lg border border-fg-12 bg-transparent px-3 py-2 text-sm leading-relaxed',
      ...
      case 'heading':
        return (
          <div className="grid gap-3 md:grid-cols-[2fr,1fr]">
            <input
              type="text"
              className="rounded-lg border border-fg-12 bg-transparent px-3 py-2 text-sm"
              value={content.text}
      ...
      case 'callout':
        return (
          <div className="space-y-3">
            ...
            <input
              type="text"
              className="w-full rounded-lg border border-fg-12 bg-transparent px-3 py-2 text-sm"
              value={content.title}
  ...
  return (
    <div className="wiki-block-editor-card space-y-3 h-full">
      <div className="flex items-center justify-between gap-4">
        <div>
          <p className="wiki-section-label">{meta?.label || type}</p>
