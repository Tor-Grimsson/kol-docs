          ...
          <div className="wiki-dashboard-card space-y-3">
            ...
            <div className="space-y-3">
              {priorityItems.map((item) => (
                <div key={item.id} className="rounded-lg border border-fg-08 p-3">
          ...
          <div className="wiki-dashboard-card space-y-4">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              {noteEntries.map((note) => (
                <div key={note.id} className="rounded-lg border border-fg-08 p-4 space-y-2">
          ...
          <div className="wiki-dashboard-card space-y-3">
            ...
            <div className="space-y-2 max-h-[360px] overflow-auto pr-1">
              {databaseInventory.map((db) => (
                <Link key={db.id} to={`/database/${db.id}`} className="flex items-center justify-between rounded-lg border border-fg-08 px-3 py-2 text-sm text-fg-80 hover:border-fg-16">
                  <span>{db.label}</span>
            ...
            <div className="space-y-3">
              {databaseTypes.map((type) => (
                <button
                  key={type.id}
                  type="button"
                  className="w-full rounded-lg border border-fg-08 px-3 py-2 text-left hover:border-fg-16"
                >
