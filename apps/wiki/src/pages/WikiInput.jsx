        ...
        <div className="flex flex-col gap-6">
          ...
          <label className="flex flex-col gap-2">
            ...
            <textarea
              ...
              rows={16}
              className="rounded-xl border border-fg-12 bg-transparent px-4 py-3 font-mono text-sm leading-relaxed"
            />
          </label>
        </div>
      </DocsArticle>
      ...
      <DocsArticle id="structure-preview" className="wiki-article-section space-y-4">
        ...
        <div className="space-y-4">
          {markdownStructure.sections.map((section) => (
            <div key={section.id} className="rounded-xl border border-fg-08 p-4">
